...
class Task2ModelConfig:
    ...
    # Leave as None to start from plain ImageNet weights.
...
# =====================================================================
# 3. Warm-starting from the Task 1 encoder
# =====================================================================
...
def build_task2_model(config: Optional[Task2ModelConfig] = None
    ...
    if config.task1_checkpoint is not None:
        load_task1_encoder(model, config.task1_checkpoint)
...
def main() -> None:
    ...
    print("\nAll checks passed. Ready for step 18.")
